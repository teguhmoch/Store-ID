           ...
           <div class="container">
                   ...
                   <div class="table-responsive cart_info">
                           <table class="table table-condensed">
                                   ...
                                   <tbody>
               <?php $total = 0; ?>
                 @foreach($v_checkout as $ckt)
                                           <tr>
                                                   <td class="cart_product">
                                                           <a href=""><img src="/data_file/{{$ckt->image}}" alt=""></a>
                                                   </td>
                                                   <td class="cart_description">
                                                           <h4><a href="">{{$ckt->name_product}}</a></h4>
                                                   </td>
                                                   <td class="cart_price">
                                                           <p>Rp {{$ckt->price}}</p>
                                                   </td>
                                                   ...
                                                   <td class="cart_total">
                                                           <p class="cart_total_price">Rp{{$ckt->price * $ckt->jumlah}}</p>
                                           </tr>
               <?php $total += ($ckt->jumlah * $ckt->price) ?>
               @endforeach
